...
"@
    ...
    <div class="footer">
        <p>Generated by LibraryLint v4.1</p>
    </div>
...
"@
        ...
        $html += @"
    <div class="footer">
        <p>Generated by LibraryLint v4.1 | $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')</p>
...
# Display header
Write-Host "`n=== LibraryLint v4.1 ===" -ForegroundColor Cyan
